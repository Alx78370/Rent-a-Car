            ...
            <div class="card mx-auto" style="max-width: 600px;">
                ...
                <div class="card-body">
                    ...
                    <div class="info-group">
                        <h6 class="text-center mt-3 mb-3 fs-4">Détails de la Réservation</h6>
                    ...
                    <div class="info-group2">
                        <h6 class="text-center mt-3 mb-3 fs-4">Informations du véhicule</h6>
                        ...
                        <p class="card-text text-center"><strong>Type d'énergie :</strong> <?= htmlspecialchars($reservation['vehicle_energy_type']) ?></p><hr>
                    
                        <h6 class="text-center mt-3 mb-3 fs-4">Agence de retrait du véhicule</h6>
